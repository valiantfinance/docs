...
|                                    |           |          | Must follow the following regex format for Ruby: <code>/\A <br/>\A[\(]?(0&#124;\+?61)\s*([23478])[\)]?\s*(([\s\-]_\d){8})\s_\z&#124;<br/>\A[\(]?(1300&#124;1800)[\)]?\s*(([\s\-]*\d){6})\s\*\z<br/>\z/x.freeze</code> |
...
|                                    |           |          | Must follow the following regex format for Ruby: <br/><code>/\A((?:\w[-+.]?)+)@([\w-]+(\.[a-z]+)+)\z/.freeze</code>                                                                                                   |
...
|                                    |           |          | Must follow the following regex format for Ruby: <br/><code>/\A\d{4}\z/.freeze</code>                                                                                                                                 |
...
|                                    |           |          | Must follow the following regex format for Ruby: <br/><code>/\A(?:\d\s?){11}\z/.freeze</code>                                                                                                                         |
